...
Основной домен: https://www.pinterest.com/

Все происходит в рамках одного домена.

Домены меняются только по месту пребывания:

США: www.pinterest.com — это основной домен для пользователей из США.

Германия: de.pinterest.com — этот домен предназначен для немецкоговорящих пользователей и предлагает контент на немецком языке.

Бразилия: br.pinterest.com — этот домен используется для бразильских пользователей, предоставляя контент на португальском языке.

## Расположение дата-центров

При выборе расположения датацентров ориентируемся на количество пользователей на ключевых материках (Южная и Северная Америки, Европа)

Распологаем ЦД в самых густонаселенных городах тех стран, где пользователей больше всего

Для Северной Америки - США

(Два в Нью-Йорке, один в Лос-Анджелесе)

Для Южной Америки - Бразилия

(Один в Рио-де-Жанейро)

Для Европы - Германия и Франция

(Один в Берлине, Один в Лондоне)

Карта расположения ЦД:
![alt text](image.png)

RPS на Северную Америку: 3100 RPS

RPS на Южную Америку: 1200 RPS

RPS на Европу: 2100 RPS

В Северной Америке три ЦД, на один ЦД 1000 RPS

В Южной Америке один ЦД, на один ЦД 1200 RPS

В Европе 2 цд, на один ЦД 1000 RPS

## Схема DNS

Используется Latency-based DNS.

## Схема anycast балансировки

Используем BGP Anycast
